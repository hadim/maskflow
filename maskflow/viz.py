...
def batch_display_top_masks(dataset, class_names, basesize=14, limit=4, cmap="PuBu_r"):
    ...
    for feature in dataset:
        ...
        display_top_masks(image, masks, label_ids, class_names, basesize=basesize, limit=limit, cmap=cmap)
...
def draw_image(image,
    ...
    for i in range(len(label_ids)):
        ...
        if draw_bbox:
            ...
            drawn_image = cv2.rectangle(drawn_image, point1, point2, color=color, thickness=rectangle_line_thickness)
